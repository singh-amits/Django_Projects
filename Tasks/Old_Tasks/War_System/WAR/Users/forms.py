...
class CreateUserForm(UserCreationForm):
    class Meta:
        ...
        widgets = {
            ...
            'is_superuser': forms.CheckboxInput(attrs={"class": "check", 'id': 'superuser', 'type': 'checkbox', 'name': "issuperuser"}),            
            'is_staff': forms.CheckboxInput(attrs={"class": "check", 'id': 'staff', 'type': 'checkbox', 'name': "isstaff"}),            
